    ...
    <div className="w-full bg-blue-500 fixed top-0 left-0 z-50">
      <div className="navbar bg-blue-500 shadow-sm">
        <div className="navbar-start">
          ...
          <span className="text-sm md:text-xl font-semibold hover:text-black cursor-[url('https://cdn-icons-png.flaticon.com/24/11316/11316997.png'),pointer]">
            Dev's Stores
          </span>
        </div>
        <div className="navbar-center hidden md:flex">
          <ul className="menu menu-horizontal px-1">
            {navarray.map((item) => (
              <li key={item.name} className="hover:text-black font-semibold">
                <a>{item.name}</a>
              </li>
            ))}
          </ul>
        ...
        <div className="navbar-end">
          ...
          {user ? (
            ...
            <button className="btn btn-ghost normal-case" onClick={() => navigate("login")}>
              Login
            </button>
          )}
